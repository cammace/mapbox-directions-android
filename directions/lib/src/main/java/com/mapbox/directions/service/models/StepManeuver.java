...
public class StepManeuver {
     ...
     * <p>It's important to note that these values might change and/or more could be added. Therefore,
     * <a href="https://www.mapbox.com/developers/api/directions/">check here</a> so you don't
     * leave one out.
